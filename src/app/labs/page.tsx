    ...
    const loadLabs = useCallback(async () => {
        try {
            ...
            setLabs(raw.map((item: any) => ({
                ...
                collectionDate: item.collectedDate || item.collectionDate || item.collection_date || item.specimenCollectedDate || item.effectiveDate || item.effectiveDateTime || undefined,
                resultDate: item.reportedDate || item.resultDate || item.result_date || item.resultDateTime || item.signedAt || item.issued || undefined,
